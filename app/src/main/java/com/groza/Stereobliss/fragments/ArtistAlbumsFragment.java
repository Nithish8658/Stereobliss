...
import com.groza.Stereobliss.adapter.AlbumsRecyclerViewAdapter;
...
import com.groza.Stereobliss.utils.RecyclerScrollSpeedListener;
...
public class ArtistAlbumsFragment extends StereoblissRecyclerFragment<AlbumModel, GenericViewItemHolder> implements CoverBitmapLoader.CoverBitmapReceiver, ArtworkManager.onNewArtistImageListener, StereoblissRecyclerView.OnItemClickListener {
