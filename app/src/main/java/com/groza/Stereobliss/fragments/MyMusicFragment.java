...
public class MyMusicFragment extends Fragment implements TabLayout.OnTabSelectedListener {
     ...
     */
    protected ToolbarAndFABCallback mToolbarA
        ndFABCallback;
    ...
    public void onTabSelected(TabLayout.Tab tab) {
        ...
        final StereoblissFragment<?> fragment = mMyMusicPagerAdapter.getRegisteredFragment(tab.getPosition());
    ...
    private static class MyMusicPagerAdapter extends FragmentStatePagerAdapter {
        ...
        private final SparseArray<StereoblissFragment<?>> mRegisteredFragments;
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            StereoblissFragment<?> fragment = (StereoblissFragment<?>) super.instantiateItem(container, position);
        ...
        public StereoblissFragment<?> getRegisteredFragment(int position) {
