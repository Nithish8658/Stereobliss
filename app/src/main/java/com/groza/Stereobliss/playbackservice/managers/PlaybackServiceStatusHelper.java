...
package com.groza.Stereobliss.playbackservice.managers;
...
import com.groza.Stereobliss.playbackservice.PlaybackService;
import com.groza.Stereobliss.playbackservice.RemoteControlReceiver;
...
public class PlaybackServiceStatusHelper {
     ...
     */
    public static final String MESSAGE_NEWTRACKINFORMATION = "com.gateshipone.odyssey.newtrackinfo";
    public static final String MESSAGE_WORKING = "com.gateshipone.odyssey.working";
    public static final String MESSAGE_IDLE = "com.gateshipone.odyssey.idle";
    public static final String MESSAGE_HIDE_ARTWORK_CHANGED = "com.gateshipone.odyssey.hideartworkchanged";

    public static final String MESSAGE_EXTRA_HIDE_ARTWORK_CHANGED_VALUE = "com.gateshipone.odyssey.hideartwork.changed.value";
    ...
    private final StereoblissNotificationManager mNotificationManager;
    ...
    public PlaybackServiceStatusHelper(PlaybackService playbackService) {
        ...
        mNotificationManager = new StereoblissNotificationManager(mPlaybackService);
    ...
    public void notifyLastFM(TrackModel currentTrack, SLS_STATES slsState) {
        ...
        bCast.putExtra("app-package", "com.gateshipone.odyssey");
    ...
    public void hideArtwork(boolean enable) {
        ...
        /*
         * Informs the {@link com.gateshipone.odyssey.widget.StereoblissWidgetProvider}
         * to hide its artwork.
         */
        mPlaybackService.sendBroadcast(settingChangedIntent);
