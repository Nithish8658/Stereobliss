 ...
 */
public class StereoblissNotificationManager {
    ...
    public StereoblissNotificationManager(Context context) {
        mContext = context;
    ...
    public synchronized void updateNotification(TrackModel track, PlaybackService.PLAYSTATE state, MediaSessionCompat.Token mediaSessionToken) {
        ...
        if (track != null) {
            ...
            Intent mainIntent = new Intent(mContext, StereoblissMainActivity.class);
