...
import com.groza.Stereobliss.models.TrackRandomGenerator;
import com.groza.Stereobliss.utils.FileExplorerHelper;
import com.groza.Stereobliss.utils.MetaDataLoader;
...
public class PlaybackService extends Service implements AudioManager.OnAudioFocusChangeListener, MetaDataLoader.MetaDataLoaderListener {
     ...
     */
    public static final String ACTION_PLAY = "com.gateshipone.odyssey.play";
    public static final String ACTION_PAUSE = "com.gateshipone.odyssey.pause";
    public static final String ACTION_NEXT = "com.gateshipone.odyssey.next";
    public static final String ACTION_PREVIOUS = "com.gateshipone.odyssey.previous";
    public static final String ACTION_SEEKTO = "com.gateshipone.odyssey.seekto";
    public static final String ACTION_STOP = "com.gateshipone.odyssey.stop";
    public static final String ACTION_QUIT = "com.gateshipone.odyssey.quit";
    public static final String ACTION_TOGGLEPAUSE = "com.gateshipone.odyssey.togglepause";
    public static final String ACTION_SLEEPSTOP = "com.gateshipone.odyssey.sleepstop";
    ...
    public IBinder onBind(Intent intent) {
        return new StereoblissPlaybackServiceInterface(this);
    }
    ...
    public void onCreate() {
        ...
        StereoblissServiceState state = mDatabaseManager.getState();
    ...
    private void stopService() {
        ...
        StereoblissServiceState serviceState = new StereoblissServiceState();
    ...
    public void resumeBookmark(long timestamp) {
        ...
        StereoblissServiceState state = mDatabaseManager.getState(timestamp);
     ...
     * the PlaybackService. Also the receiver for the Stereobliss event (e.x.
