...
import com.groza.Stereobliss.playbackservice.StereoblissServiceState;
...
public class OdysseyDatabaseManager extends SQLiteOpenHelper {
     ...
     */
    public void saveState(List<TrackModel> playList, StereoblissServiceState state, String title, boolean autosave) {
     ...
     */
    public StereoblissServiceState getState(final long timeStamp) {

        final SQLiteDatabase odysseyDB = getReadableDatabase();

        final StereoblissServiceState state = new StereoblissServiceState();
     ...
     */
    public StereoblissServiceState getState() {
