...
import com.groza.Stereobliss.artwork.network.artprovider.FanartTVProvider;
import com.groza.Stereobliss.artwork.network.artprovider.LastFMProvider;
import com.groza.Stereobliss.artwork.network.artprovider.MusicBrainzProvider;
...
import com.groza.Stereobliss.utils.BitmapUtils;
...
import com.groza.Stereobliss.widget.StereoblissWidgetProvider;
...
public class ArtworkManager implements ArtProvider.ArtFetchError, InsertImageTask.ImageSavedCallback {
     ...
     * Broadcast constants
     */
    public static final String ACTION_NEW_ARTWORK_READY = "com.gateshipone.odyssey.action_new_artwork_ready";

    public static final String INTENT_EXTRA_KEY_ALBUM_ID = "com.gateshipone.odyssey.extra.album_id";

    private static final String INTENT_EXTRA_KEY_ALBUM_NAME = "com.gateshipone.odyssey.extra.album_name";

    private static final String INTENT_EXTRA_KEY_ARTIST_ID = "com.gateshipone.odyssey.extra.artist_id";

    private static final String INTENT_EXTRA_KEY_ARTIST_NAME = "com.gateshipone.odyssey.extra.artist_name";
     ...
     * the {@link StereoblissWidgetProvider} to reload its artwork.
     *
